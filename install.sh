...
mkdir img
curl https://raw.githubusercontent.com/raphaelwb/TED_MCOM/main/Logo-FenixBook-elemento.png > ./img/Logo-FenixBook-elemento.png
curl https://raw.githubusercontent.com/raphaelwb/TED_MCOM/main/Logo-FenixBook-elemento.png > ./img/Logo-FenixBook-horizontal.png
python3 -m venv venv
